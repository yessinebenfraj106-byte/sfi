...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-red-600 selection:text-white flex flex-col">
      ...
      <footer className="w-full p-8 border-t border-zinc-900 flex justify-end items-center text-xs text-zinc-600 uppercase tracking-widest font-semibold gap-4 z-10 bg-black">
